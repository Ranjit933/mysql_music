...
SELECT COUNT(*) AS C,billing_country
 ...
 -- Q.no.4. Which city has the best customers? We would like to throw a promotional Music Festival in the city 
...
-- Q.no.5 Who is the best customer? The customer who has spent the most money will be declared the best customer. 
...
-- Q.NO.9 Find how much amount spent by each customer on artists? Write a query to return customer name, 
...
-- Q.NO.10 We want to find out the most popular music Genre for each country. We determine the most popular genre as
...
-- Optionally, you can add a SELECT statement to use the results of the CTE
SELECT * 
FROM popular_genre
WHERE RowNO <= 1
...
-- Q.NO.11 Write a query that determines the customer that has spent the most on music for each country.
